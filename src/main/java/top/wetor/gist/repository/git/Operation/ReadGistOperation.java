...
public class ReadGistOperation implements Callable<GistResponse> {
	...
	public ReadGistOperation(RepositoryLayout layout, String gistId, String commitId, User user) {
		this.layout = layout;
		this.gistId = gistId;
	...
	public ReadGistOperation(File repositoryFolder, String gistId, String commitId, User user) {
		this(new RepositoryLayout(repositoryFolder), gistId, commitId, user);
	}

	public ReadGistOperation(RepositoryLayout layout, String gistId, User user) {
		this(layout, gistId, null, user);

	}

	public ReadGistOperation(File repositoryFolder, String gistId, User user) {
