...
public class GrantedAuthorityGistSecurityManager implements GistSecurityManager {
    ...
    private GistAccessRight calculateAccessRight(GistRepository repository, User userDetails) {
        GistAccessRight right = GistAccessRight.NONE;
    ...
    private GistRole calculateRole(GistRepository repository, User userDetails) {
        GistRole role = GistRole.NONE;
    ...
    private boolean hasCollaboratorRole(GistRepository repository, User userDetails) {
    ...
    private boolean hasOwnerRole(GistRepository repository, User userDetails) {
        boolean owner = false;
    ...
    private boolean hasUserAuthority(User userDetails) {
